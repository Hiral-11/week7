...
/** Write a java program to input student Name,roll no and three subjects Maths,Science and English marks
 * (marks is between0 to 100 and if it is out of range print error message "Invalid Input, Marks should between 0 to 100")
...
public class Programme_3_MarkSheet {
    public static void main(String[] args) {
        ...
        if (Math > 100 || Math < 0) {
            ...
            //Science
            System.out.println("Input Marks of Science");
